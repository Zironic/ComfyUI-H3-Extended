...
def install():
    ...
    if current is None:
        ...
        return False
    if getattr(current, "_h3_int64", False):
        return True

    _original = current
    per_thread_int8_i64._h3_int64 = True
...
def uninstall():
    ...
    try:
        ...
        return
    if getattr(sage_core.per_thread_int8_triton, "_h3_int64", False):
...
def is_installed():
    try:
        ...
        return False
    return getattr(getattr(sage_core, "per_thread_int8_triton", None), "_h3_int64", False)
